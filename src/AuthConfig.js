...
export const msalConfig = {
  auth: {
    ...
    authority:
      'https://login.microsoftonline.com/2c631f90-6a65-4bb3-a626-c0f6f5790a9a', // This is a URL (e.g. https://login.microsoftonline.com/{your tenant ID})
...
export const appRoles = {
  PUBLIC:'PUBLIC',
  VR_Package_Manager: 'VR.Package.Manager',
  VR_Package_Approver: 'VR.Package.Approver',
  VR_Finance_Coordinator: 'VR.Finance.Coordinator'
};
